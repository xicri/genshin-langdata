...
export default [
  ...
  },
  {
    ...
    zhTW: "傑克(楓丹)",
    tags: [ "fontaine", "character-sub" ],
    notes: "魔神任務第4章第2幕に登場するキャラクター。原題には (フォンテーヌ) はついていません。システム制約によりキーを重複させないための処置です。",
    notesZh: "魔神任务 第四章·第二幕「仿若无因飘落的轻雨」中的登场角色。原标题不包括（枫丹）。这是为了防止由于系统限制而出现重复密钥的措施。",
    notesZhTW: "魔神任務 第四章·第二幕「仿若無因飄落的輕雨」中的登場角色。原标题不包括（楓丹）。這是為了防止由於系統限制而出現重複密鑰的措施。",
  },
  {
    en: "Phantom Weasel",
    ja: "怪盗マーテン",
